...
#include "VINinjaCharacter.generated.h"
...
/**
 * Bridges NinjaCharacter Plugin with VaultIt
 */
UCLASS()
class VININJABRIDGE_API AVINinjaCharacter : public ANinjaCharacter, public IVIPawnInterface, public IAbilitySystemInterface
{
	GENERATED_BODY()
...
public:
	AVINinjaCharacter(const FObjectInitializer& OI);
