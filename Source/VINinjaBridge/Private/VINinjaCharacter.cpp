...
AVINinjaCharacter::AVINinjaCharacter(const FObjectInitializer& OI)
	: Super(OI)
{
...
#if WITH_EDITOR
void AVINinjaCharacter::PostEditChangeProperty(struct FPropertyChangedEvent& PropertyChangedEvent)
{
	Super::PostEditChangeProperty(PropertyChangedEvent);

	if (PropertyChangedEvent.GetPropertyName().IsEqual(GET_MEMBER_NAME_CHECKED(AVINinjaCharacter, AbilitySystemReplicationMode)))
	{
...
void AVINinjaCharacter::BeginPlay()
{
	Super::BeginPlay();
...
void AVINinjaCharacter::PossessedBy(AController* NewController)
{
...
void AVINinjaCharacter::OnRep_Controller()
{
...
void AVINinjaCharacter::CheckJumpInput(float DeltaTime)
{
...
void AVINinjaCharacter::GetLifetimeReplicatedProps(TArray<FLifetimeProperty>& OutLifetimeProps) const
{
	Super::GetLifetimeReplicatedProps(OutLifetimeProps);

	DOREPLIFETIME_CONDITION(AVINinjaCharacter, bRepIsVaulting, COND_SimulatedOnly);
	DOREPLIFETIME_CONDITION(AVINinjaCharacter, RepMotionMatch, COND_SimulatedOnly);
}

void AVINinjaCharacter::Jump()
{
...
void AVINinjaCharacter::StopJumping()
{
	Super::StopJumping();
...
void AVINinjaCharacter::StartVaultAbility_Implementation()
{
	// Called by GA_Vault
...
void AVINinjaCharacter::StopVaultAbility()
{
...
void AVINinjaCharacter::OnRep_MotionMatch()
{
...
bool AVINinjaCharacter::IsVaulting() const
{
...
FVector AVINinjaCharacter::GetVaultDirection_Implementation() const
{
...
bool AVINinjaCharacter::CanVault_Implementation() const
{
...
void AVINinjaCharacter::OnLocalPlayerVault_Implementation(const FVector& Location, const FVector& Direction)
{
...
void AVINinjaCharacter::GetVaultLocationAndDirection_Implementation(FVector& OutLocation, FVector& OutDirection) const
{
...
void AVINinjaCharacter::ReplicateMotionMatch_Implementation(const FVIRepMotionMatch& MotionMatch)
{
...
bool AVINinjaCharacter::IsWalkable_Implementation(const FHitResult& HitResult) const
{
	// Surface we hit can be walked on or not
	return GetCharacterMovement() && GetCharacterMovement()->IsWalkable(HitResult);
}

bool AVINinjaCharacter::CanAutoVaultInCustomMovementMode_Implementation() const
{
	return true;
...
UAbilitySystemComponent* AVINinjaCharacter::GetAbilitySystemComponent() const
{
